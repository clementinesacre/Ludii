...
public class GrowingBoardVisual extends GrowingBoard
{
	 ...
	 */
	private static void updateBoardDimensions(final PlayerApp app, final Boardless board, final int newSize) 
	{
	 ...
	 * @param replayMoves
	 */
	public static void updateBoard(final PlayerApp app, final int fromSize, final int toSize, final boolean replayMoves)
	{
		Context context =  app.manager().ref().context();
		Game game = context.game();
		Boardless board = (Boardless) game.board();
	 ...
	 */
	public static void checkMoveImpactOnBoard(final PlayerApp app, final Move move, final int fromSize, final int toSize, final boolean replayMoves) 
	{
		...
		if (context.game().isBoardless()) 
		{
			...
			if (isTouchingEdge(move.to()))
				updateBoard(app, fromSize, toSize, replayMoves);
		}
	}
}

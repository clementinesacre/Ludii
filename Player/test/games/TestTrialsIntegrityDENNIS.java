 ...
 */
public class TestTrialsIntegrityDENNIS
{
	/**
	 * The test to run
	 * 
...
//						System.out.println("loadedMoves.get(moveIdx) = " + loadedMoves.get(moveIdx));
					...
					{
						System.out.println("trial.ranking() = " + Arrays.toString(trial.ranking()));
						System.out.println("loadedTrial.ranking() = " + Arrays.toString(loadedTrial.ranking()));
					}
					Assert.assertArrayEquals(trial.ranking(), loadedTrial.ranking(), 0.00001);
				}
			}
		}
